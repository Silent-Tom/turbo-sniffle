...
exports.update = function (json) {
  ...
  for (var buddy in json) {
	...
	*/
	...
	json[buddy].params[0].def_attributes.push({attribute_id: 203,factor: 1});
	json[buddy].params[0].def_attributes.push({attribute_id: 212,factor: 1});
	json[buddy].params[0].def_attributes.push({attribute_id: 214,factor: 1});
	...
	json[buddy].status_ailments.push(611);
	json[buddy].status_ailments.push(608);
